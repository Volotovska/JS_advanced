  ...
  */
  ...
  /*
    Посмотрим на то, как создание переменной отобрадается в глобальном обьекте:
  */
  ...
  // console.log('IN GLOBAL OBJECT:\N1.', window.SOMEVARIABLE, '\N2.' , window.DRINKTEA );
...
/*
  ...
  Location - показывает состояние агента пользователя и идентифицирует его.
...
/*
  Обратите внимание что обьект screen показывает именно размер экрана, а не размер окна!
  Для того что бы получить размер именно окна с контентом есть другие методы.
